    ...
    <h2 style="color:#fff;">
        <span class="logoAppsMav">
			...
			<div style="background: rgb(255, 255, 255) none repeat scroll 0% 0%; border-right: 1px solid rgb(204, 204, 204); border-left: 4px solid green; color: rgb(51, 51, 51); font-size: 12px; padding: 15px; margin-bottom: 15px;">				
				...
				<p>Thank you for considering Gratisfaction.</p>
				<p>If you face any problem installing this app, simply email to <a href="mailto:sales@appsmav.com">sales@appsmav.com</a></p><br>
		...
		<!-- Form for setting ends form here -->	
			...
			?>
            <div class="ConnectBlock" id="loaderBlock" style="display:<?=$displayLoaderBlock?>;position:relative;">
				<div class="modal fade js-loading-bar3" style="background:rgba(51, 51, 51, 0.7)">
            ...
            <div class="ConnectBlock" id="settingBlock" style="display:<?=$displaySettingBlock?>;position:relative;">
               <iframe src="<?=$frame_url?>" id='frameSetting' frameborder="0" height="800px" width='100%' scrolling="auto" ></iframe>		
			</div>
			 <script src="https://appsmav.com/gr/assets/js/iframeResizer.min.js"></script>
	<!-- Form for setting ends here -->
	
	<!-- Form for registeration Starts here -->
	<div class="ConnectBlock" id="registerBlock" style="display:<?=$displayRegisterBlock?>;position:relative;">
	 <form class="formGr form-horizontal" method="post" action="#" id="registerForm">
		<input type="hidden" name="action" value="create_account" />
		<?php $current_user = wp_get_current_user();?>
			<h2 style="margin-bottom: 40px; color: rgb(255, 255, 255); border-radius: 5px;">Get Started with FREE FOREVER Installation in minutes &amp; see your leads, referrals &amp; sales grow</h2>
			<div class="form-group">
				<label for="grconnect_reg_email" class="col-sm-5 control-label">Email <span class="asterisk">*</span>
							<button title="" data-placement="bottom" data-toggle="tooltip" class="btn btn-default helpNote" type="button" data-original-title="All emails will be sent to this email address. Also, all system generated notification emails to your customers will show this as the sender's email address.">?</button></label>
				<div class="col-sm-4">
					<?php echo get_bloginfo('admin_email'); ?>
					<input type="hidden" name="grconnect_reg_email" id="grconnect_reg_email" value="<?php echo get_bloginfo('admin_email'); ?>" maxlength="250" class="form-control /">
					</div>
			</div>
			<div class="form-group">
...
on><option value="SY">Syrian Arab Republic</option><option value="TW">Taiwan</option><option value="TJ">Tajikistan</option><option value="TZ">Tanzania</option><option value="TH">Thailand</option><option value="TL">Timor-Leste</option><option value="TG">Togo</option><option value="TK">Tokelau</option><option value="TO">Tonga</option><option value="TT">Trinidad And Tobago</option><option value="TN">Tunisia</option><option value="TR">Turkey</option><option value="TM">Turkmenistan</option><option value="TC">Turks And Caicos Islands</option><option value="TV">Tuvalu</option><option value="UG">Uganda</option><option value="UA">Ukraine</option><option value="AE">United Arab Emirates</option><option value="GB">United Kingdom</option><option value="US">United States</option><option value="UM">United States Outlying Islands</option><option value="UY">Uruguay</option><option value="UZ">Uzbekistan</option><option value="VU">Vanuatu</option><option value="VE">Venezuela</option><option value="VN">Viet Nam</option><option value="VG">Virgin Islands, British</option><option value="VI">Virgin Islands, U.S.</option><option value="WF">Wallis And Futuna</option><option value="EH">Western Sahara</option><option value="YE">Yemen</option><option value="ZM">Zambia</option><option value="ZW">Zimbabwe</option></select>
			...
			<div class="form-group">
				<label for="grconnect_reg_campaign_name" class="control-label col-sm-5">Enter your Rewards Program Name <span class="asterisk">*</span>
							<button title="" data-placement="bottom" data-toggle="tooltip" class="btn btn-default helpNote" type="button" data-original-title="This is the Rewards Program Name. This Title will be shown to your website visitors for e.g. in default widgets. So please keep it short & sweet. E.g. Shopping Rewards, Pink Rewards, Platinum Rewards, <Your Business Name> Rewards. You can also use catchy names which are unique to your business.">?</button></label>
			<div class="col-sm-4">
...
<script src="<?=plugin_dir_url( __FILE__ )?>../js/bootstrap.min.js"></script>
 <script src="<?=plugin_dir_url( __FILE__ )?>../js/jquery.validity.js"></script>
<script type="text/javascript">
	...
	function callRegister(){
		...
		//jQuery('#grconnect_reg_email').require('Please add email');
		//jQuery('#grconnect_reg_email').match('email','Please add proper format email');
		
		jQuery('#grconnect_reg_firstname').require('Please add first name');
		jQuery('#grconnect_reg_lastname').require('Please add last name');
		
		jQuery('#grconnect_reg_companyname').require('Please add company name');
		jQuery('#grconnect_reg_address1').require('Please add Address');
		jQuery('#grconnect_reg_city').require('Please add City');
		jQuery('#grconnect_reg_state').require('Please add State');
		jQuery('#grconnect_reg_postcode').require('Please add postcode / zip');
		
		jQuery('#grconnect_reg_phonenumber').require('Please add phone');
		jQuery('#grconnect_reg_phonenumber').match('integer','Please add phone numeric only');
		
		jQuery('#grconnect_reg_campaign_name').require('Please add campaign name');
		jQuery('#grconnect_reg_exclusion_period').require('Please add exclusion period');
		jQuery('#grconnect_reg_exclusion_period').match('integer','Please enter the exclusion period in days');
		jQuery('#grconnect_reg_exclusion_period').lessThan(60,'Please enter the exclusion period lesser than 61 days');
	...
	function callLoader(){
		...
		jQuery.post(
			...
			function(response){
				...
				{
					alert(response.msg);
					jQuery('#loaderBlock').html(response.msg);
					$modal.modal('hide');
					jQuery('body').removeClass('modal-open');
					...
					jQuery('#registerBlock').show('slow');
					jQuery('#loaderBlock').hide();
					$modal.modal('hide');
					jQuery('body').removeClass('modal-open');
				}
